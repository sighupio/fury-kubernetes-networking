...
$ make help
 ...
 Choose a command to run in fury-kubernetes-networking:
...
```bash
$ make deploy-all
# This deploys calico and ip-masq
```
...
INFO[0000] Building JSON for: module fury-kubernetes-networking, version v1.9.1
```
