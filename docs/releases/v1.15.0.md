...
| ----------------- | -------------------------------------------------------------------------------- | ---------------- |
| `calico`          | [`v3.27.0`](https://docs.tigera.io/calico/3.27/release-notes/)   | `v3.26.1`        |
| `cilium`          | [`v1.14.3`](https://github.com/cilium/cilium/releases/tag/v1.15.0)               | `v1.13.1`        |
| `ip-masq`         | [`v2.8.0`](https://github.com/kubernetes-sigs/ip-masq-agent/releases/tag/v2.5.0) | No update        |
| `tigera-operator` | [`v1.30.7`](https://github.com/tigera/operator/releases/tag/v1.32.3)             | `v1.30.4`        |
