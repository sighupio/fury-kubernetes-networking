...
PROJECTNAME := "fury-kubernetes-networking"
...
## deploy-all: Deploys all the components in the networking module
deploy-all: deploy-calico deploy-ip-masq

## deploy-calico: Deploys the `calico` component in the cluster
deploy-calico: check-kustomize check-kubectl
	@kustomize build katalog/calico | kubectl apply -f-

## deploy-ip-masq: Deploys the `ip-masq` component in the cluster
deploy-ip-masq: check-kustomize check-kubectl
